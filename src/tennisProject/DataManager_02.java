...
public class DataManager_02 {
	
	private static DataManager_02 instance = new DataManager_02();
	//TODO 선수 이름
	...
	private DataManager_02() { }
	public static DataManager_02 getInstance() {
		if (instance == null)
			instance = new DataManager_02();
		return instance;
	}
	...
	public void pointWinner(int teamNumber) {//누가 1점땄다
		...
		// 게임 듀스 로직
		if (gameScore[teamNumber] == 6) { // 6점이 되면
			setScore[teamNumber]++; // 
